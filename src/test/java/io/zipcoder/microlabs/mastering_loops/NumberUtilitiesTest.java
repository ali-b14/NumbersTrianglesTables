...
public class NumberUtilitiesTest {
    ...
    public void testGetRange1A() {
        ...
        int stop = 10; //Ali changed this from 11. it was wrong.
    ...
    public void testGetRange3B() {
        // : Given
        String expected = "100101102103104105106107108109";// Ali added 102
        int start = 100;
        int stop = 110;
    ...
    @Test// Ali changed these tests, who the hell wrote these?
